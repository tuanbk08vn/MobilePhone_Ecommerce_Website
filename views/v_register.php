	...
	<div class="modal-dialog"> 
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					<p id="register-display" class="col-xs-12" style="text-align: center">Tuan Pham</p>
					...
					<form method="POST" action="" name="register">
						...
						<div class="form-group col-xs-6">
							<p>Birthday:</p>
							<input class="form-control" id="birthday" value="" name="birthday" placeholder="Birthday" type="times">
						</div>
						<div class="form-group col-xs-6">
							<p>Email:</p>
						...
						<div class="form-group col-xs-12">
							<div class="col-sm-6 col-md-6 left" style="padding: 2px">
								<button type="submit" id="register-submit" onclick="return validateRegister();" class="btn btn-success btn-block btn-md" name="register">Register</button>
							</div>
